...
directory = 'assets/MNIST/N=4000-2D/epoch=%d-noise-5' % epochs
...
if __name__ == '__main__':
    ...
    array = []
    f = open('../assets/MNIST/N=4000-2D/epoch=4000-noise-20/epoch=4000.txt', 'r')
    for line in f:
        pair = re.findall(r"(\d*\.*\d+)", line)
        print(pair)
        array.append(pair)
    ...
    plt.plot(hidden_units, test_losses, marker='o', label='0% Label Noise dataset Error')
    plt.plot(hidden_units, train_losses, marker='o', label='0% Label Noise Train Error')
    plt.plot(hidden_units_2, test_losses_2, marker='o', label='20% Label Noise dataset Error')
    ...
    plt.plot(parameters, test_losses, marker='o', label='0% Label Noise dataset Error')
    plt.plot(parameters, train_losses, marker='o', label='0% Label Noise Train Error')
    plt.plot(parameters_2, test_losses_2, marker='o', label='20% Label Noise dataset Error')
    ...
    plt.plot(hidden_units, test_accs, marker='o', label='0% Label Noise dataset Error')
    plt.plot(hidden_units, train_accs, marker='o', label='0% Label Noise Train Error')
    plt.plot(hidden_units_2, test_accs_2, marker='o', label='20% Label Noise dataset Error')
    ...
    plt.plot(parameters, test_accs, marker='o', label='0% Label Noise dataset Error')
    plt.plot(parameters, train_accs, marker='o', label='0% Label Noise Train Error')
    plt.plot(parameters_2, test_accs_2, marker='o', label='20% Label Noise dataset Error')
